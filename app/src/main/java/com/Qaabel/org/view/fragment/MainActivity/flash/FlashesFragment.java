package com.Qaabel.org.view.fragment.MainActivity.flash;
...
public class FlashesFragment extends Fragment
{
    ...
    private static final String TAG = "FlashesFragment";
    private void getFlashes(String token)
    {
        profileViewModel.getFlashes(token).observe(this, apiFreindsResponse -> {
            ...
            {
                Log.d(TAG, "getFlashes: ------------------------"+apiFreindsResponse.getFlashes());
